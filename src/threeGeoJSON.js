...
export function drawThreeGeo({ json, radius, materalOptions }) {
  console.log("GeoJSON data received:", json);
  ...
  for (let geom_num = 0; geom_num < json_geom.length; geom_num++) {
    console.log(`Processing geometry type: ${json_geom[geom_num].type}`);

    if (json_geom[geom_num].type == "Point") {
      convertToSphereCoords(json_geom[geom_num].coordinates, radius);
      console.log(
        "Point coordinates converted to sphere:",
        x_values,
        y_values,
        z_values
      );
      ...
      for (
        ...
        console.log(
          "MultiPoint coordinates converted to sphere:",
          x_values,
          y_values,
          z_values
        );
      ...
      console.log("LineString coordinate array:", coordinate_array);
      ...
      console.log(
        "LineString coordinates converted to sphere:",
        x_values,
        y_values,
        z_values
      );
      ...
      for (
        ...
        console.log("Polygon segment coordinate array:", coordinate_array);
        ...
        console.log(
          "Polygon segment coordinates converted to sphere:",
          x_values,
          y_values,
          z_values
        );
      ...
      for (
        ...
        console.log(
          "MultiLineString segment coordinate array:",
          coordinate_array
        );
        ...
        console.log(
          "MultiLineString segment coordinates converted to sphere:",
          x_values,
          y_values,
          z_values
        );
      ...
      for (
        ...
        for (
          ...
          console.log(
            "MultiPolygon segment coordinate array:",
            coordinate_array
          );
          ...
          console.log(
            "MultiPolygon segment coordinates converted to sphere:",
            x_values,
            y_values,
            z_values
          );
